...
class SmoothOrbitControls extends EventDispatcher {
  object: Camera;
  ...
  constructor(object: Camera, domElement?: HTMLElement) {
    ...
    function getDistanceScaleFactor() {
      return (
        (scope.getDistance() - scope.minDistance) /
        (scope.maxDistance - scope.minDistance)
      );
    }

    function getZoomScale(): number {
      const scale = 1 - getDistanceScaleFactor() * 0.05;

      return scale;
    }

    function rotateLeft(angle: number): void {
      angle = angle * getDistanceScaleFactor();
...
class MapControls extends SmoothOrbitControls {
  constructor(object: Camera, domElement?: HTMLElement) {
...
export { SmoothOrbitControls, MapControls };
